...
def get_summary_figure_html(event_mapping: Dict[str, str], matching_name, events_matching_metadata, matching_info: xr.Dataset, stats, slope, shift, tol):
...
def sync(reference_event_df: pd.DataFrame, relative_event_df: pd.DataFrame, 
         event_mapping: Dict[ str|int, str|int], tolerance: float, progress: bool = False
